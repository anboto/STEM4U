...
:: [s0; [*2 HERMITE`_3]]
:: [s0; [2 Hermite`'s rule with a three points difference scheme to approximate 
...
Simpson`'s rule]&]
[s3;i150;O0;%% [^https`:`/`/epubs`.siam`.org`/doi`/pdf`/10`.1137`/S0036144502416308^ `"
An Invitation to Hermite’s Integration and Summation: A Comparison 
...
[s4;%% &]
[s1; &]
[s2;:Upp`:`:IntegralSinCos`(const Range`&`,const Range`&`,typename Range`:`:value`_type`,bool`): [@(0.0.255) t
emplate] <Range> [@(0.0.255) typename] Range[@(0.0.255) `::]value`_type 
[* IntegralSinCos]([@(0.0.255) const] Range[@(0.0.255) `&] [*@3 x], [@(0.0.255) const] 
Range[@(0.0.255) `&] [*@3 f], [@(0.0.255) typename] Range[@(0.0.255) `::]value`_type 
[*@3 t], [@(0.0.255) bool] [*@3 iscos])&]
[s3;%% Obtains the numerical integration of data series defined by 
equidistant points [%-*@3 x] and, depending on [%-*@3 iscos] flag:&]
